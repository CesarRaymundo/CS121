...
//	private final String TIE = "T";
	...
	public TicTacToeGUI() {
		...
		Font bigFont = new Font("Times New Roman", Font.PLAIN, 28);
		Font smallFont = new Font("Times New Roman", Font.PLAIN, 26);
		...
		for (int row = 0; row < DIM; row++) {
			for (int col = 0; col < DIM; col++) {
				...
				gameGrid[row][col].setPreferredSize(new Dimension(100,100));
		...
		movesTextArea.setPreferredSize(new Dimension(200,250));
